...
TICKER_DB = {
    ...
    "Sterling and Wilson Renewable Energy": ["SWSOLAR.NS", "SWSOLAR.BO"],
    "Tanla Platforms Ltd": ["TANLA.NS,", "TANLA.BO"],
    "Hindustan Aeronautics": ["HAL.NS", "HAL.BO"],
    "Larsen & Toubro": ["LT.NS", "LT.BO"],
    "Tata Chemicals Limited (TATACHEM.NS)": ["TATACHEM.NS", "TATACHEM.BO"],
}
